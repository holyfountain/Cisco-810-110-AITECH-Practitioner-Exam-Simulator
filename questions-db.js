window.QUESTION_BANK = [
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "letter": "B",
        "text": "One-shot prompting with contextual grounding"
      },
      {
        "letter": "C",
    ...
    "rationaleCorrect": "B. One-shot prompting with contextual grounding is correct because the prompt includes a single example while also supplying task-specific constraints and structural context, which is the prompt design choice most likely to produce the requested behavior in this refactoring scenario.",
    "rationaleIncorrect": "The other options point to different engineering activities or unrealistic guarantees, but they do not solve the workflow constraint in the prompt.",
    "multiSelect": false
  },
  {
  ...
  },
  {
    ...
    "rationaleCorrect": "Because visual generation benefits from explicit constraints on non-text output attributes is correct because image-generation prompts become more controllable and precise when they specify visual properties such as composition, lighting, and style.",
    "rationaleIncorrect": "The other options may sound related, but they either adjust the wrong control, confuse prompting with architecture changes, or weaken the intended instruction pattern.",
    "multiSelect": false
  },
  {
